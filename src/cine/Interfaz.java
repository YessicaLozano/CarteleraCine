...
public final class Interfaz extends JFrame implements ActionListener{
    ...
    public Interfaz(){
        ...
        b1 = new JButton("Conmprar entradas: COCO");
        b2 = new JButton("Conmprar entradas: BLOODSHOT");
        b3 = new JButton("Conmprar entradas: BIRDS OF PREY");
        b4 = new JButton("Conmprar entradas: JUMANJI: THE NEXT LEVEL");
        b5 = new JButton("Conmprar entradas: DOCTOR SLEEP");
        b6 = new JButton("Conmprar entradas: THE CALL OF THE WILD");
        b7 = new JButton("Conmprar entradas: BAD BOYS FOR LIFE");
        b8 = new JButton("Conmprar entradas: BOMBSHELL");
        b9 = new JButton("Conmprar entradas: ZOMBIELAND: DOUBLE TAP");
        b10 = new JButton("Conmprar entradas: CHARLIE’S ANGELS");
        ...
        p1.add(l1,BorderLayout.BEFORE_FIRST_LINE);
        ...
        p1.add(ta3);
         ...
         int n = 0;
         n=imprimir();
         ta1.append(lista.get(n).toString());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int entradaPeli, tot = 0;
     
        int n = 0;
        if(e.getActionCommand().equals("COCO")){
           n=1;
           entradaPeli = 1;
           tot += entradaPeli;
            acumulado(tot, entradaPeli);
            ta1.append(lista.get(n).toString()); 
     ...
     public  void acumulado ( int  tot, int valor){
         ta2.append(String.valueOf(tot));
         ta3.append(String.valueOf(valor));
    }
